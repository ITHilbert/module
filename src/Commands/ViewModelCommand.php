...
use ITHilbert\Module\Classes\ViewCreater;

class ViewModelCommand extends Command
{
    protected $signature = 'module:view {viewName} {modelName}';
    ...
    public function handle()
    {
        ...
        $vc = new ViewCreater($modelName);
        $content = $vc->getForm();

        // Create the file
        $path = base_path("/module/{$modulName}/Resources/views/{$viewName}.blade.php");
